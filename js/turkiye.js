	...
	for (var county in paths) {
		...
		{				
			...
			.hover(function(){
				...
				searchbox.value= paths[arr[this.id]].name;
				//console.log("searcbox value is here ",searchbox.value);
				...
				function getResults(query) {
				  ...
				  function displayResults(weather) {
					...
					city.innerText = `${weather.name.replace(" Province", "")}, ${weather.sys.country}`;
